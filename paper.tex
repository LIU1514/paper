...
\begin{figure}[h]
	...
	\centering
	\subfigcapskip=5pt
	\subfigure[In train set, we segement an utterance into segements of length 2 seconds with an overlap of length 1 second between each segement and use them as independent data in training.]{
	\begin{minipage}{10cm}
		\flushleft
		\includegraphics[width=0.85\columnwidth]{pic/train_set}
	\end{minipage}}
	\subfigure[In test set,we segement an utterance into segements of length 2 seconds with an overlap of length 1.6 second between each segement and average the prediction of each segement of a source utterance to obtain the final prediction.]{
		\begin{minipage}{10cm}
			\flushleft
...
\begin{figure}[h]
	...
	\subfigcapskip=5pt
	\centering
	\subfigure[when n\_size is 32, we obtain the highest accuracy when n\_head is 4]{
		\begin{minipage}{9cm}
			\centering
			\flushleft
			\includegraphics[width=0.93\linewidth]{pic/n_size32}
	\end{minipage}}
	\subfigure[when n\_size is 64, we obtain the highest accuracy when n\_head is 4]{
		\begin{minipage}{9cm}
			\centering
			\flushleft
			\includegraphics[width=0.93\linewidth]{pic/n_size64}
	\end{minipage}}
		\subfigure[when n\_size is 128, we obtain the highest accuracy when n\_head is 3]{
		\begin{minipage}{9cm}
			\centering
			\flushleft
